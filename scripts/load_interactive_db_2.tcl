...
#set step_dir "/home/isaishaq/openlane2/designs/picorv_test/runs/RUN_2026-03-01_15-10-18/74-dqn-resizer-test/"
set ::env(CURRENT_SPEF) "$::env(STEP_DIR)/50-openroad-rcx/"
...
set ::env(_TCL_ENV_IN) ${env(STEP_DIR)}/_env.tcl
...
set_cmd_units\
    ...
    # Get pre-DQN timing metrics for all corners
